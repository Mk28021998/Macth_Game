...
class App extends Component {
  ...
  render() {
    const {imgUrl, time, score, category, isTrue} = this.state
        ...
        <div className="content-div">
          {!isTrue && (
            <div className="first-div">
              <img className="match-img" alt="match" src={imgUrl} />
              <ul className="list-cont1">
                {tabsList.map(eachValue => {
                  const click1 = () => {
                    this.clickTab(eachValue.tabId)
                  }
                  return (
              ...
              <ul className="list-cont2">
                {thumbnailList.map(eachObj => (
                  <li key={eachObj.id}>
                    <button
                      className="imageList-btn"
                      type="button"
